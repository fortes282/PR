    ...
    <div className="space-y-6">
      ...
      <section>
        <h2 className="flex items-center gap-2 font-medium text-gray-700">
          Upravit kredity
          <HelpTooltip
            title="Úprava kreditu"
            description="Přidá nebo odečte částku z kreditu klienta. Zadejte kladné číslo (doplnění) nebo záporné (odečtení) a důvod. Změna se zapíše do logu profilu klienta."
          />
        </h2>
      ...
      <section>
        ...
        <p className="text-sm text-gray-600">
          Odeslaná oznámení, změny údajů, úpravy hodnocení a reset hesla. Viditelné pro recepci i administrátora.
        </p>
