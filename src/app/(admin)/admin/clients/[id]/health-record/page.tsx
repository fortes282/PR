...
export default function AdminClientHealthRecordPage(): React.ReactElement {
  ...
  return (
    <div className="space-y-6">
      <Link href={`/admin/clients/${id}`} className="text-sm text-primary-600 hover:underline">
        ← {user.name}
      </Link>
      <h1 className="text-2xl font-bold text-gray-900">Zdravotní záznam</h1>
